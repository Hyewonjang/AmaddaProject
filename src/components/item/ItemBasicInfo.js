...
const ItemBasicInfo = (props) => {
    ...
    props.propFunction(productNum)
    props.propFunction2(props.sale_price*productNum)

    const[subscribeText, setSubscribeText] = useState('구독하기')

    const changeST = ()=>{
        if(subscribeText == '구독하기')
            setSubscribeText('구독완료')
        else{
            setSubscribeText('구독하기')
        }

        props.propFunction3(1)
        props.propFunction4()
    }
                                ...
                                <div className="row align-items-end">
                                    ...
                                    <div className="col-lg-4 col-md-4 col-12">
                                        <div className="wish-button">
                                            <button className="btn" onClick={changeST}><i className="lni lni-heart"></i>{subscribeText}</button>
                                        </div>
                                    </div>
                                    {/* <div className="col-lg-4 col-md-4 col-12">
                                        <div className="wish-button">
