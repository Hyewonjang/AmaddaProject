    ...
    return(
        ...
        <div className="coupon-items">
            <div className="coupon-item">
                <div style={{float:'left'}}><button className="item-checkbox-btn" style={{border:'0px', marginRight:'10px',color:'gray'}} onClick={(e)=>item_checked(e, e.target.checked, 50)}><i className="lni lni-checkmark" style={{border:"1px solid gray", fontSize:'8px', padding: '3px'}}></i></button></div>
            ...
            <div className="coupon-item">
                <div style={{float:'left'}}><button className="item-checkbox-btn" style={{border:'0px', marginRight:'10px',color:'gray'}} onClick={(e)=>item_checked(e, e.target.checked, 70)}><i className="lni lni-checkmark" style={{border:"1px solid gray", fontSize:'8px', padding: '3px'}}></i></button></div>
