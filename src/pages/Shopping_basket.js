...
const Shopping_basket = (props) => {
  const [productNumUpdate, setProductNumUpdate] = useState(props.productNum);
      ...
      <React.Fragment>
        ...
        <section className="shopping-basket section">
            <div className="container">
                <SB_Frame>
                    <SB_Frame_Title/>
                    <SB_Item productNum={productNumUpdate} propFunction2={setProductNumUpdate} propFunction = {CouponPopup} product_image = {product_image0} product_name = '샴푸 펌프 병(대형)' preprice={4500} coupon_sale_price={0} delivery_price={0} />
                ...
                <SB_Total_Price productNum={productNumUpdate} product_total_preprice={4500} total_coupon_sale_price ={salePoint} total_delivery_price={0} propFunction={props.propFunction} />
                {cpPopupShow ? <Select_Coupon_Popup propFunction = {CouponPopup} propFunction2= {setSalePoint}/> : ""}
            </div>
        </section>         
